...
## Recent Changes
- 2025-10-28: **تحديث استخراج المركز الانتخابي** ✅
  - **التحسين الجديد**:
    * إضافة استراتيجية جديدة لاستخراج المركز الانتخابي من العنصر السابق لعنصر "العنوان"
    * البحث عن عنصر "العنوان" أولاً، ثم الحصول على العنصر السابق له (preceding-sibling)
    * هذا يتوافق مع هيكل الصفحة الحالي حيث يظهر المركز الانتخابي فوق العنوان مباشرة
    * إضافة طرق احتياطية متعددة لضمان استخراج البيانات بنجاح
